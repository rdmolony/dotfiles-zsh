...
__conda_setup="$('/home/wsl-rowanm/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/wsl-rowanm/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/wsl-rowanm/miniconda3/etc/profile.d/conda.sh"
    else
